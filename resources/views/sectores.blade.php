            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-100 card-hover-effect transition-all duration-300 flex flex-col h-full relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="flex gap-2">
                            <span class="bg-gray-100 text-gray-600 text-xs font-bold px-2.5 py-1 rounded">IAF: 36</span>
                            <span class="bg-gray-100 text-gray-600 text-xs font-bold px-2.5 py-1 rounded">NACE: L/84</span>
                        </div>
                    </div>
                    <h4 class="text-2xl font-bold text-secondary mb-2">Administración Pública</h4>
                    <p class="text-primary-600 text-sm font-medium mb-6">Una maravillosa colaboración desde 2014</p>
                    
                    <div class="space-y-4 flex-grow text-gray-600 text-sm leading-relaxed">
                        <div>
                            <strong class="text-secondary block mb-1">¿Qué comprende?</strong>
                        ...
                        <div>
                            <strong class="text-secondary block mb-1">¿Qué incluye?</strong>
                    ...
                    <div class="mt-6 pt-5 border-t border-gray-100">
                        <strong class="text-primary-700 flex items-center gap-2 mb-2">
                            <i data-lucide="target" class="w-4 h-4"></i> Finalidad
                        </strong>
                        <p class="text-sm text-gray-600">Garantizar un entorno institucional eficiente, transparente y orientado al bienestar colectivo y la competitividad del país.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-100 card-hover-effect transition-all duration-300 flex flex-col h-full relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="flex gap-2 flex-wrap justify-end max-w-[50%]">
                            <span class="bg-gray-100 text-gray-600 text-xs font-bold px-2.5 py-1 rounded mb-1">IAF: 38</span>
                            <span class="bg-gray-100 text-gray-600 text-xs font-bold px-2.5 py-1 rounded mb-1">NACE: N/75, 86, 87, 88</span>
                        </div>
                    </div>
                    <h4 class="text-2xl font-bold text-secondary mb-2">Salud y Asistencia Social</h4>
                    <p class="text-rose-600 text-sm font-medium mb-6">Creciendo juntos desde 2016</p>
                    ...
                    <div class="mt-6 pt-5 border-t border-gray-100">
                        <strong class="text-rose-600 flex items-center gap-2 mb-2">
                            <i data-lucide="target" class="w-4 h-4"></i> Finalidad
                        </strong>
                        <p class="text-sm text-gray-600">Aseguramos que los procesos cumplan con estándares nacionales e internacionales, garantizando atención segura, ética y eficaz.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-100 card-hover-effect transition-all duration-300 flex flex-col h-full relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="flex gap-2">
                            <span class="bg-gray-100 text-gray-600 text-xs font-bold px-2.5 py-1 rounded">IAF: 37</span>
                        </div>
                    </div>
                    <h4 class="text-2xl font-bold text-secondary mb-2">Sector Educativo</h4>
                    <p class="text-amber-600 text-sm font-medium mb-6">Una colaboración exitosa desde 2019</p>
                    ...
                    <div class="mt-6 pt-5 border-t border-gray-100">
                        <strong class="text-amber-600 flex items-center gap-2 mb-2">
                            <i data-lucide="target" class="w-4 h-4"></i> Finalidad
                        </strong>
                        <p class="text-sm text-gray-600">Nuestro enfoque en la certificación fortalece la confianza y la excelencia en los procesos formativos e instituciones académicas.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-100 card-hover-effect transition-all duration-300 flex flex-col h-full relative overflow-hidden group">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="flex gap-2">
                            <span class="bg-gray-100 text-gray-600 text-xs font-bold px-2.5 py-1 rounded">IAF: 39</span>
                        </div>
                    </div>
                    <h4 class="text-2xl font-bold text-secondary mb-2">Servicios Sociales y Sostenibilidad</h4>
                    <p class="text-emerald-600 text-sm font-medium mb-6">Socios exitosos desde 2021</p>
                    ...
                    <div class="mt-6 pt-5 border-t border-gray-100">
                        <strong class="text-emerald-600 flex items-center gap-2 mb-2">
                            <i data-lucide="target" class="w-4 h-4"></i> Finalidad
                        </strong>
                        <p class="text-sm text-gray-600">Certificamos procesos que garantizan la sostenibilidad, seguridad y calidad en el servicio, impactando directamente en el bienestar comunitario y medio ambiente.</p>
                    </div>
                </div>
